...
export function HeroSection() {
  ...
  return (
    <>
      <link
        href="https://fonts.googleapis.com/css2?family=Manrope:wght@800;900&family=Archivo:wght@300;400&display=swap"
        rel="stylesheet"
      />
            ...
            <div className="max-w-7xl mx-auto px-8 md:px-16 w-full pb-28 md:pb-36">
              <div className="max-w-2xl">
                ...
                <motion.h1
                  ...
                  style={{
                    fontFamily: '"Manrope","Inter","Helvetica Now","Neue Haas Grotesk",sans-serif',
                    fontWeight: 900,
                    fontStyle: 'normal',
