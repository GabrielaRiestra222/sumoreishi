...
const CONTENT: Record<string, { sections: { title?: string; body: string }[] }> = {
  ...
  "como-tomar-reishi": {
    sections: [
      ...
      { title: "Dosis recomendada", body: "La pauta recomendada para Sumo Reishi es de 6 cápsulas al día.\n\nPuedes tomarlas de una vez por la mañana o repartirlas entre mañana y tarde. Preferiblemente, 30 minutos antes de las comidas y con agua." },
